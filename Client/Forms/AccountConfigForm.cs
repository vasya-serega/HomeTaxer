...
namespace HomeTaxer.Client.Forms
{
    public partial class AccountConfigForm : Form
    {
        ...
        private bool _wasAccountsUpdated = false;

        public AccountConfigForm(HtService service, Dictionary<int, string> accounts)
        {
            _service = service;
            _accounts = accounts;
        ...
        public bool WasAccountsUpdated => _wasAccountsUpdated;
